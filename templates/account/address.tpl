            ...
            <div class="col-md-8">
                {% embed "snipplets/forms/form.tpl" with{form_id: 'address-form', submit_custom_class: 'btn-block', submit_text: 'Guardar dirección' | translate } %}
                    {% block form_body %}
                        ...
                        {% embed "snipplets/forms/form-input.tpl" with{type_text: true, input_for: 'name', input_value: result.name | default(address.name), input_name: 'name', input_id: 'name', input_label_text: 'Nombre (alias)' | translate } %}
