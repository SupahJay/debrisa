    ...
    {% if suboptions.options %}
        ...
        {% if store.has_shipping_polish %}
            ...
            <div data-toggle="#{{ modal_id_val }}" class="js-modal-open btn-link btn-link-primary">
                ...
                <span class="align-bottom">{{ 'Ver puntos de retiro' | translate }}</span>
            </div>
        ...
        {% else %}
            ...
            <div class="js-shipping-suboption-product mb-1" style="display: none;">{{ 'Vas a poder elegir alguna de las siguientes opciones antes de finalizar la compra:' | translate }}</div>
