<section class="js-home-slider-container{% if not settings.slider or settings.slider is empty %} hidden{% else %}{% if not settings.slider_full %} mt-4{% endif %}{% endif %}" data-store="slider-main">
