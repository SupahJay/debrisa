...
{% set has_multiple_slides = product.images_count > 1 or has_product_video %}

{% if show_labels %}
  <div class="{% if has_product_video and product %}js-labels-group{% endif %} labels {% if product_detail and has_multiple_slides %}labels-product-slider{% endif %}">
