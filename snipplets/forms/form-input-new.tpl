...
<div class="form-group {{ input_group_custom_class }}">
    ...
    {% else %}
        <input 
            ...
            {% if input_id %}id="{{ input_id }}"{% endif %}
            class="form-control {% if type_password %}js-password-input{% endif %} {{ input_custom_class }} {% if input_append_content %}form-control-inline{% endif %}" 
            autocorrect="off" 
            autocapitalize="off" 
            ...
            {% if type_password %} 
            <a title="" aria-label="" class="js-password-view btn form-toggle-eye">
                <span class="eye-open" style="display: none;">
